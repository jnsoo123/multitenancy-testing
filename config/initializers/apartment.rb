...
class CustomElevator < Apartment::Elevators::Subdomain
  def parse_tenant_name(request)
    subdomain = super
    raise ::Apartment::TenantNotFound unless ['multitenancy_testing_development', 'mt_test_1'].include? subdomain
    return subdomain
  end
end
#
...
Apartment.configure do |config|
  ...
  # end
  #
  config.tenant_names = lambda { ['multitenancy_testing_development', 'mt_test_1'] }
